...
"""Carrega dados de validação por produção no banco de dados da Impulso."""
...
sisab_validacao_municipios_por_producao = tabelas[
...
def carregar_dados(
    ...
    requisicao_insercao = sisab_validacao_municipios_por_producao.insert().values(registros)
