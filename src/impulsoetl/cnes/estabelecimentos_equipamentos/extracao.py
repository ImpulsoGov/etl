...
def extrair_equipamentos_estabelecimentos(codigo_municipio: str, lista_cnes: list) -> pd.DataFrame:
    ...
    for l in lista_cnes:
        ...
        try:
            ...
            url = "http://cnes.datasus.gov.br/services/estabelecimentos-equipamento/"+coMun+l
