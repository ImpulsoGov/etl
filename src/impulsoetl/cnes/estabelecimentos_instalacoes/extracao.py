...
def extrair_instalacoes_estabelecimentos(codigo_municipio: str, lista_cnes: list) -> pd.DataFrame:
    ...
    for l in lista_cnes:
        ...
        try:
            ...
            url = "http://cnes.datasus.gov.br/services/estabelecimentos/instalacoes/"+coMun+l
...
data = instalacoes[['municipio_id_sus','estabelecimento_cnes_id','tipo','descricao','qtInstalacoes','qtLeitos']]
