...
def tratamento_dados(
    ...
    df_extraido['horario_funcionamento'] = df_extraido['diaSemana'] + " " + df_extraido['hrInicioAtendimento'] + "-" + df_extraido['hrFimAtendimento']
    df_extraido = df_extraido.groupby(['municipio_id_sus','estabelecimento_cnes_id'], as_index=False).agg({'horario_funcionamento': ' '.join})
...
df_extraido = extrair_horario_atendimento_estabelecimentos(codigo_municipio,lista_codigos)
